...
Future<MyTripsResponseData> tripListApi(
    MyTripsRequestData requestData) async {
...
Future<ExportPdfResponseData> listexportPdfApi(ExportPdfRequestData requestData) async {
  final response = await _apiProvider.httpRequest(
    resource: Resource(
...
Future<tripListCancelTripResponse> ListcancelTripApi(tripListCancelTripRequest requestData) async {
  final response = await _apiProvider.httpRequest(
    resource: Resource(
